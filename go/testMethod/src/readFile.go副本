...
func main() {
	...
	// 读取参数
	inputFile := os.Args[1]
	inputFile = "/Users/xionghaitao/Desktop/mogontest/test-user.csv"
...
func processLine(line []byte) {
	...
	//  userId:=filedArray1[0]
	//	userName := filedArray1[1];
	//	email := filedArray1[2];
	//  password:=filedArray1[3]
	//  createtime:=filedArray1[4]
	//	disable := filedArray1[5]
	//	active := filedArray1[6]
	//	nickname := filedArray1[7]
	//	channel := filedArray1[8]
	//	mobile := filedArray1[9]
	//	realname := filedArray1[10]
	//	gender := filedArray1[11]
	//	image := filedArray1[12]
	//	address := filedArray1[13]
