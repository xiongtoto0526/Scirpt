...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"下拉刷新",),NSLocalizedString(@"松开刷新",),
                             NSLocalizedString(@"加载中",),
                                nil];
        
        self.subtitles = [NSMutableArray arrayWithObjects:title, title, title, title, nil];
