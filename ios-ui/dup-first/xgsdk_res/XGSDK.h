...
@property (nonatomic, retain) NSString *roleLevel;
@property (nonatomic, retain) NSString *roleVipLevel;
...
@property (nonatomic, retain) NSString *tradeSN;
...
@property (nonatomic, retain) NSString *productUnitPrice;
...
@property (nonatomic, retain) NSString *zoneId;
@property (nonatomic, retain) NSString *partyName;
@property (nonatomic, retain) NSString *virtualCurrencyBalance;
@property (nonatomic, retain) NSString *customInfo;
@property (nonatomic, retain) NSString *gameTradeNo;
@property (nonatomic, retain) NSString *gameCallbackUrl;
