...
- (void)setupViews
{
    ...
    CGRect pcFrame = CGRectMake(mainWidth *.5 - size.width *.5, mainHeight - size.height-HEIGHT_OF_PAGE_CONTROL, size.width, size.height);// origin y, -20 to cover the image
    ...
    pageControl.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.0];// add xht 背景色改为黑
//    pageControl.alpha=1;
